...
console.log("syncuserName"+syncuserName);
    $.getJSON('/twilio/synctoken/'+syncuserName, function(tokenResponse) {
console.log("tokenResponse");
console.log("tokenResponse"+tokenResponse);
console.log("tokenResponse"+tokenResponse.syncaccessToken);
        syncClient = new Twilio.Sync.Client(tokenResponse.syncaccessToken, { logLevel: 'info' });
